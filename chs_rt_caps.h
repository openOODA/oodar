#ifndef CHS_RT_CAPS_H
#define CHS_RT_CAPS_H
#include "chs_rt_types.h"
#include "chs_rt_sandbox.h"
...
#define CHS_CAP_TIME 64u
#define CHS_CAP_RAND 128u
#define CHS_CAP_ALLOC 256u
#define CHS_CAP_ARENA 512u
#define CHS_CAP_FFI 1024u
#define CHS_CAP_AUDIT 2048u
#define CHS_CAP_SIGN 4096u
#define CHS_CAP_HITL 8192u
#define CHS_CAP_SYNC 16384u
#define CHS_CAP_MEM 32768u
#define CHS_CAP_HTTP (1u << 16)
#define CHS_CAP_TCP (1u << 17)
#define CHS_CAP_UDP (1u << 18)
#define CHS_CAP_BIND (1u << 19)
#define CHS_CAP_AUDIO (1u << 20)
#define CHS_CAP_CAMERA (1u << 21)
#define CHS_CAP_USB (1u << 22)
#define CHS_CAP_HID (1u << 23)
#define CHS_CAP_WINDOW (1u << 24)
#define CHS_CAP_FRAME (1u << 25)
#define CHS_CAP_THREAD (1u << 26)
#define CHS_CAP_GPU (1u << 27)
#define CHS_CAP_ENV (1u << 28)
#define CHS_CAP_COMPILER_READ (1u << 29)
